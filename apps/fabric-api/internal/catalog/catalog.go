...
func DefaultCatalog(cfg Config) Catalog {
	return Catalog{
		...
		ProductPresets: []ProductPreset{
			{ID: "basic", Name: "Basic", Accelerator: "cpu", DefaultCPU: 2, DefaultMemoryGB: 4, DefaultGPU: 0, DefaultDiskGB: 10, Available: true, ComputeProfileID: "cpu-general", StorageClassID: "workspace-cbs", WorkspaceImageID: "one-person-lab-app", IngressDomainID: "workspace", SchedulingPolicyID: "workspace-exclusive-cvm"},
			{ID: "pro", Name: "Pro", Accelerator: "cpu", DefaultCPU: 8, DefaultMemoryGB: 16, DefaultGPU: 0, DefaultDiskGB: 100, Available: true, ComputeProfileID: "cpu-general", StorageClassID: "workspace-cbs", WorkspaceImageID: "one-person-lab-app", IngressDomainID: "workspace", SchedulingPolicyID: "workspace-exclusive-cvm"},
			{ID: "gpu", Name: "GPU", Accelerator: "gpu", DefaultCPU: 16, DefaultMemoryGB: 64, DefaultGPU: 1, DefaultDiskGB: 500, Available: false, UnavailableReason: "gpu_capacity_not_verified", ComputeProfileID: "gpu-general", StorageClassID: "workspace-cbs", WorkspaceImageID: "one-person-lab-app", IngressDomainID: "workspace", SchedulingPolicyID: "workspace-exclusive-cvm"},
		},
		...
		ProviderInstanceTypes: []ProviderInstanceType{
			{ID: "tencent-cpu-dynamic", Provider: "tencent-cloud", Region: "config:TENCENT_TKE_REGION", Family: "S/C/M series", InstanceType: "resolved-by-tencent-sdk", Accelerator: "cpu", MinCPU: 1, MaxCPU: 64, MinMemoryGB: 1, MaxMemoryGB: 256, MaxGPU: 0, CapacityPoolIDs: []string{"tencent-cpu-compute-pool"}, Available: true},
			{ID: "tencent-gpu-dynamic", Provider: "tencent-cloud", Region: "config:TENCENT_TKE_REGION", Family: "GPU series", InstanceType: "resolved-by-tencent-sdk", Accelerator: "gpu", MinCPU: 4, MaxCPU: 128, MinMemoryGB: 16, MaxMemoryGB: 1024, MaxGPU: 8, CapacityPoolIDs: []string{"tencent-gpu-compute-pool"}, Available: false},
		},
		CapacityPools: []CapacityPool{
			{ID: "tencent-cpu-compute-pool", Provider: "tencent-tke", Kind: "nodepool_by_instance_type", IsolationMode: "workspace_exclusive_cvm", Region: "config:TENCENT_TKE_REGION", ComputeProfileIDs: []string{"cpu-general"}, Available: true},
			{ID: "tencent-gpu-compute-pool", Provider: "tencent-tke", Kind: "nodepool_by_instance_type", IsolationMode: "workspace_exclusive_cvm", Region: "config:TENCENT_TKE_REGION", ComputeProfileIDs: []string{"gpu-general"}, Available: false, UnavailableReason: "gpu_capacity_not_verified"},
		},
		SchedulingPolicies: []SchedulingPolicy{
			{ID: "workspace-exclusive-cvm", Mode: "workspace_exclusive_cvm", CapacityPoolKind: "nodepool_by_instance_type", CreatePoolIfMissing: false, RejectIfNoCapacity: true, Description: "Allocate one account-owned CVM node from the matching ComputePool while retaining Workspace storage separately."},
		},
