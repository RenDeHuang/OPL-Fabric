...
func TestLiveWorkspaceChainE2EIsGated(t *testing.T) {
	...
	result := EvaluateGate(Config{
		...
		NodePoolLaunchJSON:      os.Getenv("OPL_TKE_NODEPOOL_LAUNCH_CONFIGURE_PARA_JSON"),
		NodePoolAutoscalingJSON: os.Getenv("OPL_TKE_NODEPOOL_AUTOSCALING_GROUP_PARA_JSON"),
